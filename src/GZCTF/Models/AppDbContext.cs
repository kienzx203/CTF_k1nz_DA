    ...
    IdentityDbContext<UserInfo, IdentityRole<Guid>, Guid>(options), IDataProtectionKeyContext
{
    ...
    public DbSet<CourseClass> Classes { get; set; } = null!;
    public DbSet<CourseMember> ClassMembers { get; set; } = null!;
    public DbSet<LabSession> LabSessions { get; set; } = null!;
    public DbSet<LabSessionChallenge> LabSessionChallenges { get; set; } = null!;
    ...
    public DbSet<ClassExercise> ClassExercises { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // === Course & Lab ===
        builder.Entity<GZCTF.Models.Data.CourseClass>(entity =>
        {
        ...
        builder.Entity<GZCTF.Models.Data.CourseMember>(entity =>
        {
        ...
        builder.Entity<GZCTF.Models.Data.LabSession>(entity =>
        {
        ...
        builder.Entity<GZCTF.Models.Data.LabSessionChallenge>(entity =>
        {
        ...
        builder.Entity<GZCTF.Models.Data.LabReport>(entity =>
        {
        ...
        // === Practice (Class ↔ Exercise) ===
        builder.Entity<GZCTF.Models.Data.ClassExercise>(entity =>
        {
            entity.HasIndex(e => e.ClassId);

            entity.HasOne(e => e.Class)
                  .WithMany(c => c.PracticeExercises)
                  .HasForeignKey(e => e.ClassId)
                  .OnDelete(DeleteBehavior.Cascade);
