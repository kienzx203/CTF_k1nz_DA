...
builder.Services.AddScoped<IUserClaimsPrincipalFactory<UserInfo>, AppClaimsPrincipalFactory>();
...
builder.Services.AddScoped<ILabSessionRepository, LabSessionRepository>();
builder.Services.AddScoped<ILabReportRepository, LabReportRepository>();
builder.Services.AddScoped<IClassRepository, ClassRepository>();
builder.Services.AddScoped<ILabSessionRepository, LabSessionRepository>();
builder.Services.AddScoped<ILabReportRepository, LabReportRepository>();
builder.Services.AddScoped<IClassExerciseRepository, ClassExerciseRepository>();
var app = builder.Build();
using (var scope = app.Services.CreateScope())
    await SeedUsers.RunAsync(scope.ServiceProvider);
