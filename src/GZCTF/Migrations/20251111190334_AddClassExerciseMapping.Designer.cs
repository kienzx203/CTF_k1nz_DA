...
namespace GZCTF.Migrations
{
    ...
    [Migration("20251111190334_AddClassExerciseMapping")]
    partial class AddClassExerciseMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ClassExercise", b =>
                {
            ...
            modelBuilder.Entity("GZCTF.Models.Data.CourseClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.CourseMember", b =>
                {
                    b.Property<int>("ClassId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.LabReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("GradedUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.LabSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.LabSessionChallenge", b =>
                {
                    b.Property<int>("SessionId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LabSessionChallenges");
                });
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ClassExercise", b =>
                {
                    b.HasOne("GZCTF.Models.Data.CourseClass", "Class")
            ...
            modelBuilder.Entity("GZCTF.Models.Data.LabReport", b =>
                {
                    ...
                    b.HasOne("GZCTF.Models.Data.UserInfo", "GradedBy")
                        .WithMany()
                        .HasForeignKey("GradedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GZCTF.Models.Data.LabSession", "Session")
                        .WithMany("Reports")
